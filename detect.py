...
#Anything changed from original is marked by EDIT
...
def detect(save_img=False):
    ...
    # Directories
    save_dir = Path(increment_path(Path('runs/detect') / 'exp', exist_ok= False))  # increment run adam
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        line = (cls, *xywh, conf) if False else (cls, *xywh)  # label format adam
